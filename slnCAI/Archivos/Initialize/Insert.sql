...
insert into seguridad_permiso (idPermiso,permiso,pagina,url,estado,idUsuario) values (34,'asistencia','Procesos','#tabAsistencia',1,'System');

INSERT INTO `tipo_identificacion_persona`(`idTipoIdentificacion`,`descripcion`,`observaciones`,`estado`,`idUsuario`) VALUES(1,'Cédula','',1,'System');
INSERT INTO `tipo_identificacion_persona`(`idTipoIdentificacion`,`descripcion`,`observaciones`,`estado`,`idUsuario`) VALUES(2,'Residencia','',1,'System');
INSERT INTO `tipo_identificacion_persona`(`idTipoIdentificacion`,`descripcion`,`observaciones`,`estado`,`idUsuario`) VALUES(3,'Pasaporte','',1,'System');

CALL sp_GuardarRol(1, 'Administrador', '','System');